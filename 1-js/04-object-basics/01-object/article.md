...
كما نعلم من الفصل <info: types> ، هناك ثمانية أنواع من البيانات في JavaScript. تسمى سبعة منهم "بدائية" ، لأن قيمهم تحتوي على شيء واحد فقط (سواء كان سلسلة أو رقم أو أيا كان).
